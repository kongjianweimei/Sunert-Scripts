...
if ($.isNode()) {
  if (process.env.BAIDU1_COOKIE && process.env.BAIDU1_COOKIE.indexOf('&') > -1) {
  StartBody = process.env.BAIDU1_COOKIE.split('&');
  }
 if (process.env.BAIDU1_COOKIE && process.env.BAIDU1_COOKIE.indexOf('\n') > -1) {
  BDCookie = process.env.BAIDU1_COOKIE.split('\n');
  } else {
  BDCookie = process.env.BAIDU1_COOKIE.split()
  }
